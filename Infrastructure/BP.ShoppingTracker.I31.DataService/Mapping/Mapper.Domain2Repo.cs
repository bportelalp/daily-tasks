...
namespace BP.ShoppingTracker.I31.DataService.Mapping
{
    internal partial class Mapper : MapperBase
    {
        ...
        internal I30.Persistence.Entities.CombinedFormat Domain2Repo(Tuple<Guid,Guid> ComposedId)
        {
            if (ComposedId is null) return null;
            I30.Persistence.Entities.CombinedFormat row = new I30.Persistence.Entities.CombinedFormat()
            {
