...
namespace BP.ShoppingTracker.DataService
{
    public partial class DataService : IDataService
    {
        ...
        {
            Persistence.Entities.CombinedFormat composed = mapper.Domain2Repo(format.ComposedId);
            Persistence.Entities.Format mainFormat = mapper.Domain2Repo(format);
            Persistence.Entities.Format derivedFormat = mapper.Domain2Repo(format.DerivedFormat);
